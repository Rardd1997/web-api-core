...
namespace STOP.NET.REST
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RESTContext>(opt => opt.UseSqlServer(connection));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "STOP.NET Api", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "STOP.NET Api V1");
            });
